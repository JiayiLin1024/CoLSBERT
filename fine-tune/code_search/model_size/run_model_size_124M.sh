...
for lang in ${languages[@]}
    do
        echo $lang
        echo "*** start fine-tune on 124M model ***"

        output_dir=fine-tune/code_search/saved_models/model_size/124M/$lang
        mkdir -p $output_dir
        saved_pretrained=pre-train/saved_models/model_size/124M
