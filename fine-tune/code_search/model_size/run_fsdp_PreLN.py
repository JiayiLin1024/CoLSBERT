...
from transformers import (WEIGHTS_NAME, AdamW, get_linear_schedule_with_warmup,
                  RobertaConfig, RobertaModel, RobertaTokenizer, AutoTokenizer, RobertaPreLayerNormModel)
...
def main():
    ...
    model = RobertaPreLayerNormModel.from_pretrained(args.model_name_or_path)  
