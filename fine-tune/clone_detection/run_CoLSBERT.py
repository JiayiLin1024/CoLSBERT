...
from transformers import (WEIGHTS_NAME, AdamW, get_linear_schedule_with_warmup,
                          ...
                          RobertaPreLayerNormConfig, RobertaPreLayerNormForMaskedLM)
...
def main():
    ...
    config = RobertaPreLayerNormConfig.from_pretrained(args.model_name_or_path)
    model = RobertaPreLayerNormForMaskedLM.from_pretrained(args.model_name_or_path) 
